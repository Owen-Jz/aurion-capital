        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5" noValidate>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded-sm border-border accent-[#c9a84c] cursor-pointer"
                />
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 text-sm font-semibold uppercase tracking-[0.08em] rounded-sm transition-colors active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              style={{
                background: "var(--gold)",
          ...
          <div
            ...
            style={{ borderColor: "rgba(201,168,76,0.25)", background: "rgba(201,168,76,0.03)" }}
          >
            <p
            ...
            <div className="space-y-2">
              {[
                { role: "Investor", email: "demo@investor.com", password: "Demo@2026!", dest: "/portal" },
                { role: "Admin", email: "admin@aurioncapital.com", password: "Admin@2026!", dest: "/admin" },
              ].map((account) => (
                <button
                  key={account.role}
                  type="button"
                ...
                >
                  ...
                  <p className="text-xs mt-0.5 font-mono" style={{ color: "var(--foreground)", opacity: 0.7 }}>
                    {account.email}
                  </p>
      ...
      >
        ...
        <div className="relative z-10 p-16 flex flex-col justify-between h-full">
          ...
          <div>
            ...
            >
              &ldquo;The most important quality for an investor is temperament, not
              intellect.&rdquo;
            </blockquote>
